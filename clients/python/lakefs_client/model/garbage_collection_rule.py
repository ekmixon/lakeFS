...
class GarbageCollectionRule(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, branch_id, retention_days, *args, **kwargs):    # noqa: E501
        """GarbageCollectionRule - a model defined in OpenAPI

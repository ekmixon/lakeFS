...
class RepositoryCreation(ModelNormal):
    ...
    validations = {
        ('name',): {
            'regex': {
                'pattern': r'^[a-z0-9][a-z0-9-]{2,62}$',  # noqa: E501
            },
        },
        ('storage_namespace',): {
            'regex': {
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, storage_namespace, *args, **kwargs):    # noqa: E501
        """RepositoryCreation - a model defined in OpenAPI

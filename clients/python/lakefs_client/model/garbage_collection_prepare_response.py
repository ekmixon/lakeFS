...
class GarbageCollectionPrepareResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, run_id, gc_commits_location, gc_addresses_location, *args, **kwargs):    # noqa: E501
        """GarbageCollectionPrepareResponse - a model defined in OpenAPI
        ...
        self.run_id = run_id
        self.gc_commits_location = gc_commits_location
        self.gc_addresses_location = gc_addresses_location
